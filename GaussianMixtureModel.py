...
class GaussianMixtureModel:
    ...
    def validate(self):
        ...
        plt.savefig("GaussianMixtureModel_Clustering_SSE_{}".format(self.pltName))
        ...
        plt.savefig("GaussianMixtureModel_Clustering_NMI_{}".format(self.pltName))
